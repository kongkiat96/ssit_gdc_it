...
<div class="modal fade" id="changs_status" tabindex="-1" role="dialog" aria-labelledby="changs_status" aria-hidden="true">
  <form method="post" action="<?php echo $SERVER_NAME; ?>">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">

        <div class="changs_status">
                  ...
                  <div class="media widget-media p-4 rounded bg-white border">
                    ...
                    <div class="media-body align-self-center">
                      <h4 class="text-danger mb-2"><?php @$getall = $getdata->my_sql_show_rows($connect, "employee", "card_key <> 'hidden' AND em_status = '0'");
                                                    echo @number_format($getall); ?></h4>
                      <p><a href="#" data-toggle="modal" data-target="#changs_status">จำนวนพนักงานที่ลบออก</a></p>
                    </div>
                  </div>
                </div>
              <?php } ?>
