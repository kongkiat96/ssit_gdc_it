...
<div class="col-xl-3 text-white">
    <div class="media widget-media p-4 bg-primary border ">
        <div class="icon mr-4 ">
...
<div class="col-xl-3 text-white">
    <div class="media widget-media p-4 bg-success border">
        <div class="icon mr-4">
...
<div class="col-xl-3 text-white">
    <div class="media widget-media p-4 bg-warning border">
        <div class="icon mr-4">
...
<div class="col-xl-3 text-white">
    <div class="media widget-media p-4 bg-danger border">
        <div class="icon mr-4">
