...
?>
    <tr>
        ...
        <!-- <td><?php
                    if ($show_total->card_status == NULL) {
                        echo '<a href="#" data-toggle="modal" data-target="#off_case" data-whatever="' . @$show_total->ticket . '" class="btn btn-sm btn-outline-danger" data-top="toptitle" data-placement="top" title="ยกเลิกการแจ้ง" ><i class="fa fa-ban"></i></a>';
                    } else {
                        echo '<a href="#" data-toggle="modal" data-target="#off_case" data-whatever="' . @$show_total->ticket . '" class="btn btn-sm btn-outline-danger disabled" data-top="toptitle" data-placement="top" title="ยกเลิกการแจ้ง" ><i class="fa fa-ban"></i></a>';
                    }
                    ?>
        </td> -->
        <td>
