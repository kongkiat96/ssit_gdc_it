    ...
    <div class="card-body">
      <table width="100%" class="table">
        ...
        <tr>
          ...
          <td><strong>สถานที่ติดตั้ง :</strong></td>
          <td><?php echo $card_detail->card_location; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><strong>เบอร์โทรติดต่อ :</strong></td>
          <td>
        ...
        <tr>
          ...
          <td><?php echo @prefixConvertorbranch($card_detail->card_branch); ?></td>
          <td><strong>สถานที่ติดตั้ง :</strong></td>
          <td>
            <?php echo @($card_detail->card_location != '') ? $card_detail->card_location : '<strong><div style="color: #F00D0D">ไม่ระบุ</div></strong>'; ?>
          </td>
        </tr>
        <tr>
