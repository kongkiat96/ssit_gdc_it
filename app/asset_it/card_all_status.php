...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            <div class="col-md-3 col-sm-3"><strong>แผนก :</strong></div>
            <div class="col-md-3 col-sm-3"><?php echo @getemployee_department($card_detail->card_customer_name); ?></div>
        ...
        <div class="form-group row">
            <div class="col-md-3 col-sm-3"><strong>เบอร์โทรติดต่อ :</strong></div>
            <div class="col-md-3 col-sm-3">
