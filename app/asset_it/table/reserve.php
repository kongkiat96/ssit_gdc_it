<div class="responsive-data-table">
    <table id="responsive-data-table-it" class="table dt-responsive nowrap hover" style="width:100%">
        ...
        <tbody>
            ...
            <?php
            $l = 0;
            $getcard = $getdata->my_sql_select($connect, NULL, "card_info", "card_status = '9ba0f256a5f620136568c6b47dcb24bd' AND card_delete ='1' ORDER BY card_insert ASC");
