...
<div class="row mt-3 mb-0">
    <div class="col-md-3 col-sm-6">
        <div class="media widget-media p-4 bg-white border">
            ...
            <div class="media-body align-self-center">
                <h4 class="text-primary mb-2"><?php @$getall = $getdata->my_sql_show_rows($connect, "card_info", "card_key <> 'hidden' AND card_equipment = '1' AND card_delete ='1'");
    ...
    <div class="col-md-3 col-sm-6">
        <div class="media widget-media p-4 rounded bg-white border">
            ...
            <div class="media-body align-self-center">
                <h4 class="text-success mb-2"><?php @$getall = $getdata->my_sql_show_rows($connect, "card_info", "card_status <> 'hidden' AND card_equipment = '2' AND card_delete ='1'");
                                                echo @number_format($getall); ?></h4>
                <p>จำนวนจอภาพ</p>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="media widget-media p-4 rounded bg-white border">
            ...
            <div class="media-body align-self-center">
                <h4 class="text-warning mb-2"><?php @$getall = $getdata->my_sql_show_rows($connect, "card_info", "card_status <> 'hidden' AND card_equipment = '3' AND card_delete ='1'");
                                                echo @number_format($getall); ?></h4>
                <p>จำนวนโน๊ตบุ๊ค</p>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="media widget-media p-4 rounded bg-white border">
            ...
            <div class="media-body align-self-center">
                <h4 class="text-warning mb-2"><?php @$getall = $getdata->my_sql_show_rows($connect, "card_info", "card_status <> 'hidden' AND card_equipment = '4' AND card_delete ='1'");
                                                echo @number_format($getall); ?></h4>
