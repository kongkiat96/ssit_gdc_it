...
if (isset($_POST['save_card'])) {
    if ($getcontrol < 50) {
        if (htmlspecialchars($_POST['card_customer_name']) != NULL && htmlspecialchars($_POST['asset_code']) != NULL) {
          ...
          card_branch='" . htmlspecialchars($_POST['card_branch']) . "',
          card_location = '" . htmlspecialchars($_POST['card_customer_location']) . "',
...
<form method="post" enctype="multipart/form-data" class="was-validated" id="waitsave">
    <div class="form-group row">
        ...
        <div class="col-md-4 col-sm-12">
            <label for="asset_code">สถานที่ติดตั้ง</label>
            <input type="text" name="card_customer_location" id="card_customer_location" class="form-control input-sm" required>
            <div class="invalid-feedback">
                ระบุ สถานที่ติดตั้ง.
            </div>
        </div>
    ...
    <div class="form-group row">
        <div class="col-md-6 col-sm-12">
            <label for="card_company">สินทรัพย์ของบริษัท</label>
            <select name="card_company" id="card_company" class="form-control select2bs4" style="width: 100%;" required>
            ...
            <div class="invalid-feedback">
                ระบุ สินทรัพย์ของบริษัท.
            </div>
        </div>
        <div class="col-md-6 col-sm-12">
            <label for="card_branch">สาขา</label>
            <select name="card_branch" id="card_branch" class="form-control select2bs4" style="width: 100%;" required>
                <option value="">--- เลือกข้อมูล ---</option>
                <?php $getbranch = $getdata->my_sql_select($connect, NULL, "branch", "status = '1'  ORDER BY id");
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4 col-sm-12"> <label for="card_customer_email">อีเมล</label>
    ...
    <div class="form-group row">
        <div class="col-md-7">
            ...
            <input type="text" name="name_license" id="os" class="form-control input-sm" disabled="disabled" placeholder="Windows">
    ...
    <div class="form-group row">
        <div class="col-md-7">
            ...
            <input type="radio" name="p_ck_license" value="1">
            <label for="pck_license">
                <font color="green">License</font>
            </label>&nbsp
            <input type="radio" name="p_ck_license" value="0">
            <label for="pck_license">
                <font color="red">No license</font>
            </label>
            <input type="text" name="p_license_name" id="program" class="form-control input-sm" disabled="disabled" placeholder="Program">
            <div class="invalid-feedback">
