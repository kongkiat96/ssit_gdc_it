...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row">
      <div class="col-md-3 col-sm-3"><strong>เบอร์โทรศัพท์ :</strong></div>
      <div class="col-md-3 col-sm-3">
        <?php echo $card_detail->card_customer_phone; ?>
      </div>
      <div class="col-md-3 col-sm-3"><strong>อีเมล :</strong></div>
      <div class="col-md-3 col-sm-3"><?php echo $card_detail->card_customer_email; ?></div>
    </div>
    <div class="form-group row">
      <div class="col-md-3 col-sm-3"><strong>สาขา :</strong></div>
      <div class="col-md-3 col-sm-3"><?php echo @prefixConvertorbranch($card_detail->card_branch); ?></div>
      <div class="col-md-3 col-sm-3"><strong>สถานที่ติดตั้ง :</strong></div>
      <div class="col-md-3 col-sm-3"><?php echo $card_detail->card_location; ?></div>
  ...
  <div class="card text-center mt-3">
    ...
    <div class="card-body text-center" id="repic">
      ...
      if ($card_detail->card_pic == null) {
        echo '<img class="img-thumbnail" src="../resource/asset/file_pic_now/no-img.png" width="50%">';
      } else {
        echo '<img class="img-thumbnail" src="../resource/asset/delevymo/' . $card_detail->card_pic . '" width="50%">';
      }
      ?>
    </div>
  ...
  <div class="card text-center mt-3">
    ...
    <div class="card-footer">
      <button class="ladda-button btn btn-warning btn-square btn-ladda bg-success" data-style="expand-left" type="button" data-toggle="modal" data-target="#save_card">
        <span class="fas fa-save"> ยืนยันการบันทึกข้อมูล</span>
        <span class="ladda-spinner"></span>
      </button>
    </div>
  </div>
