  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>รหัสสินทรัพย์ :</strong></div>
        ...
        <div class="col-md-3 col-sm-6"><strong>วันที่เริ่มใช้งาน :</strong></div>
        <div class="col-md-3 col-sm-6">
          <?php
      ...
      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>ผู้ใช้งาน :</strong></div>
        <div class="col-md-3 col-sm-6">
          <?php echo @getemployee($card_detail->card_customer_name); ?>
        </div>
        <div class="col-md-3 col-sm-6"><strong>บริษัท / สังกัด :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo @getemployee_company($card_detail->card_customer_name); ?></div>
      </div>
      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>แผนก :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo @getemployee_department($card_detail->card_customer_name); ?></div>

      </div>
      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>สาขา :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo @prefixConvertorbranch($card_detail->card_branch); ?></div>
        <div class="col-md-3 col-sm-6"><strong>สถานที่ติดตั้ง :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo @$card_detail->card_location; ?></div>
      </div>

      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>เบอร์โทรติดต่อ :</strong></div>
        <div class="col-md-3 col-sm-6">
          <?php echo @$card_detail->card_customer_phone; ?>
        </div>
        <div class="col-md-3 col-sm-6"><strong>อีเมล :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo $card_detail->card_customer_email; ?></div>
      </div>
      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>จำนวน :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo @$card_detail->card_sum; ?> ชุด / ชิ้น</div>
        <div class="col-md-3 col-sm-6"><strong>วันที่ซื้อ :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo @($card_detail->card_date_buy != '0000-00-00') ? dateConvertor($card_detail->card_date_buy) : '<strong><div style="color: #F00D0D">ไม่ระบุ</div></strong>'; ?></div>
      </div>
      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>ระบบปฏิบัติการ :</strong></div>
        <div class="col-md-3 col-sm-6">
          <?php
          ...
          ?></div>
        <div class="col-md-3 col-sm-6"><strong>ลิขสิทธิ์ :</strong></div>
        <div class="col-md-3 col-sm-6">
          <?php
      ...
      <div class="form-group row">
        <div class="col-md-3 col-sm-6"><strong>โปรแกรม :</strong></div>
        <div class="col-md-3 col-sm-6">
          <?php
      ...
      <div class="row form-group">
        <div class="col-md-3 col-sm-6"><strong>ระยะเวลาที่หมดการรับประกัน :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo @($card_detail->card_date_ex != NULL) ? dateConvertor($card_detail->card_date_ex) : '<strong><div style="color: #F00D0D">ไม่ระบุ</div></strong>'; ?></div>
        <div class="col-md-3 col-sm-6"><strong>จำนวนระยเวลาคงเหลือการรับประกัน :</strong></div>
        <div class="col-md-3 col-sm-6"><?php echo $date_current; ?> วัน</div>
      </div>
      <div class="form-group row">



        <div class="col-md-3 col-sm-6"><strong>เจ้าหน้าที่บันทึกรายการ :</strong></div>
        <div class="col-md-3 col-sm-6">
          <?php
